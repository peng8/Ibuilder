<template>
  <div>
    ...
    <div class="field">
      <label class="label">内部横向对齐方式</label>
      <div class="control">
        <input class="input" type="text" v-model="$store.state.editorData.s['justify-content']">
      </div>
    </div>
    <div class="field">
      <label class="label">内部纵向对齐方式</label>
      <div class="control">
        <input class="input" type="text" v-model="$store.state.editorData.s['align-items']">
      </div>
    </div>
    <div class="field">
    ...
    <div class="field">
      ...
      <div class="control">
        <input class="input" type="text" v-model="$store.state.editorData.s['font-family']">
      </div>
    </div>
    <div class="field">
